      ...
      <main className="flex-1 flex flex-col items-center py-10">
        <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section className="text-center mb-20">
            <h1 className="text-2xl md:text-3xl font-black mb-6 leading-normal tracking-tight relative text-[#1D3557]">
              <span className="relative z-10">
                CONHEÇA O MÉTODO DE LEITURA QUE FEZ ALUNOS DO <span className="text-[#457B9D] font-extrabold">FUNDAMENTAL 1</span> LEREM <span className="bg-yellow-100 px-1 py-0.5 rounded text-[#1D3557] font-extrabold">3X MAIS</span> EM APENAS <span className="underline decoration-[#a8dadc] decoration-4">21 DIAS</span> E <span className="block">DEVOLVEU AOS PROFESSORES O <span className="text-[#457B9D] animate-pulse font-extrabold">PRAZER EM ENSINAR</span></span>
              </span>
            </h1>
          ...
          <section className="bg-white rounded-lg shadow-lg p-8 mb-20">
            ...
            <div className="max-w-2xl mx-auto text-left space-y-6">
              ...
              O que faltava era um sistema simples e eficiente capaz de integrar a leitura à rotina com propósito.
              Um método onde o aluno participa por vontade própria. E o professor volta a sentir orgulho do que ensina.
              </p>
            </div>
          </section>
          ...
          <section className="bg-white rounded-lg shadow-lg p-8 mb-20">
            ...
            <div className="flex flex-col gap-8 items-center mb-6">
              ...
              <div className="bg-gradient-to-r from-[#f8f9fa] to-[#e9ecef] p-5 rounded-lg border-l-4 border-[#6bbbed] shadow-md mb-4">                <div className="flex flex-rol items-center space-y-3">
                  <div className="text-3xl text-[#457B9D] mr-2">✨</div>
                  <p className="font-bold text-lg text-[#1D3557] text-left">
              ...
              <div className="space-y-5">
                <div className="flex gap-3 items-center">
                  ...
                  <p className="text-xl text-gray-800 mb-4">
                    <strong>93%</strong> das professoras que aplicaram o Projeto Missão Literária relatam que seus alunos passaram a ler mais, inclusive aqueles que diziam não gostar de ler.
                  </p>
                </div>
                <div className="flex gap-3 items-center">
                  <div className="text-xl min-w-[30px]">📈</div>
                ...
                <div className="flex gap-3 items-center">
                  <div className="text-xl min-w-[30px]">🏆</div>
                  <p className="text-xl text-gray-800 mb-4">
                    Uma metodologia prática e testada com sucesso por mais de <strong>3 mil professores</strong>.
                  </p>
                </div>
              </div>
            </div>
            <div className="bg-[#457B9D] text-white p-6 rounded-lg mb-8">
              <h3 className="font-bold text-xl mb-6 text-center border-b border-white pb-3">💬 Veja o que estão dizendo:</h3>
              <div className="bg-white text-gray-800 p-5 rounded-lg shadow-md mb-4">
                <p className="italic mb-3">
                  &ldquo;SAchei que ia ser só mais uma tentativa. Mas pela primeira vez, vi meus alunos empolgados com leitura. Eu chorei depois da aula..&rdquo;
                </p>
              ...
              <div className="bg-white text-gray-800 p-5 rounded-lg shadow-md mb-4">
                <p className="italic mb-3">
                  &ldquo;Tenho alunos que nunca pegaram um livro sem reclamar. Depois de duas semanas, começaram a pedir mais. Um até me perguntou quando seria a próxima leitura.&rdquo;
                </p>
              ...
              <div className="bg-white text-gray-800 p-5 rounded-lg shadow-md">
                <p className="italic mb-3">
                  &ldquo;Tentava de tudo e ninguém ligava. Mas com as missões, eles começaram a comentar os livros e até competir. Foi como tirar um peso das costas.&rdquo;
                </p>
      ...
      <section>
            <div className="bg-white rounded-lg shadow-lg py-16 px-8 mb-20 mt-8">
              ...
              <div className="text-center mb-6">
                <p className="text-md text-gray-600 mt-2 italic mb-8">Um projeto validado por professores, aplicado com sucesso em mais de 8 mil alunos, agora disponível com valor procional.</p>
            ...
            <div className="space-y-4 max-w-3xl mx-auto">
              ...
              <div className="border border-[#a8dadc] rounded-lg overflow-hidden">
                <details className="group">
                  ...
                  <div className="p-4 bg-white">
                    <p className="text-gray-800">O recurso Missão Literária foi criado especialmente para alunos do Ensino Fundamental I para alunos do 2º ao 5º ano, porém tivemos relatos de professores do fundamental 2 que utilizaram com suceso em suas aulas.</p>
                  </div>
                </details>
              </div>
              ...
              <div className="border border-[#a8dadc] rounded-lg overflow-hidden">
                <details className="group">
                  ...
                  <div className="p-4 bg-white">
                    <p className="text-gray-800">O material é 100% digital. Assim que a compra é confirmada, você recebe tudo por Whatsapp, pronto para baixar e imprimir quantas vezes quiser.</p>
                  </div>
                </details>
              </div>
              ...
              <div className="border border-[#a8dadc] rounded-lg overflow-hidden">
                <details className="group">
                  ...
                  <div className="p-4 bg-white">
                    <p className="text-gray-800">Depois do pagamento, você recebe uma mensagem no seu Whatsapp com o link para download do Google Drive. É tudo simples, direto e com acesso imediato.</p>
                  </div>
                </details>
              </div>
