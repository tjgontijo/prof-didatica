          ...
          <section className="bg-white rounded-lg shadow-lg p-8 mb-20">
            ...
            <div className="grid grid-cols-1  gap-6 mb-8">
              <div className="bg-gradient-to-r from-[#f8f9fa] to-[#e9ecef] p-5 rounded-lg border-l-4 border-[#6bbbed] shadow-md">
                ...
                <p className="text-gray-700 pl-10">De forma natural e envolvente, sem pressão ou obrigação</p>
              </div>
              ...
              <div className="bg-gradient-to-r from-[#f8f9fa] to-[#e9ecef] p-5 rounded-lg border-l-4 border-[#6bbbed] shadow-md">
                ...
                <p className="text-gray-700 pl-10">Com atividades guiadas que estimulam o pensamento crítico</p>
              </div>
              ...
              <div className="bg-gradient-to-r from-[#f8f9fa] to-[#e9ecef] p-5 rounded-lg border-l-4 border-[#6bbbed] shadow-md">
                ...
                <p className="text-gray-700 pl-10">Ao se conectarem emocionalmente com as histórias</p>
              </div>
              ...
              <div className="bg-gradient-to-r from-[#f8f9fa] to-[#e9ecef] p-5 rounded-lg border-l-4 border-[#6bbbed] shadow-md">
                ...
                <p className="text-gray-700 pl-10">Com propostas de produção textual criativas e estimulantes</p>
              </div>
