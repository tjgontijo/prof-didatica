          ...
          <section className="text-center mb-20">
            <h1 className="text-2xl md:text-3xl font-black mb-6 leading-normal tracking-tight relative text-[#1D3557]">
              <span className="relative z-10">
                ...
                EM APENAS{' '}
                <span className="underline decoration-[#a8dadc] decoration-4">21 DIAS</span> E{' '}
                <span className="block">
                  DEVOLVEU AOS PROFESSORES O{' '}
            ...
            <h2 className="text-lg md:text-xl text-[#1D3557] mb-6 max-w-3xl mx-auto font-normal leading-relaxed text-left">
              ...
              transformar a leitura em jogo e dois modelos de tabela pra acompanhar tudo. É só
