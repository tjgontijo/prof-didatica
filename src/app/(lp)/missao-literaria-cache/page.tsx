      ...
      prefetchCheckoutData(CHECKOUT_ID)
        .then((resultado) => {
          if (resultado) {
            ...
            console.warn('Não foi possível carregar os dados do checkout');
            setPrefetchErro('Não foi possível carregar os dados do checkout');
            ...
            <div className="bg-white rounded-lg shadow-lg py-16 px-8 mb-20 mt-8">
              ...
              <button
                onClick={() => {
                  ...
                  if (prefetchRealizado) {
                    // Redirecionar para a URL correta do checkout
                    router.push(`/checkout/${CHECKOUT_ID}`);
                  } else {
                    // Caso contrário, usar o link direto
                    window.location.href = `/checkout/${CHECKOUT_ID}`;
                  }
                }}
          ...
          <button
            onClick={() => {
              ...
              if (prefetchRealizado) {
                ...
                // Caso contrário, usar o link normal
                window.location.href = `/checkout/${CHECKOUT_ID}`;
              }
            }}
