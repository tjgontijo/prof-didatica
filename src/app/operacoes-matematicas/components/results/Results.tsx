...
export default function Results() {
  ...
  useEffect(() => {
    // Pool de depoimentos (usando os mesmos do DL/Missão Literária como placeholder conforme PRD)
            ...
            return (
              <div key={imageNumber} className="w-full max-w-md">
                <Image
                  ...
                  alt={`Depoimento ${testimonialNumber} de professor(a)`}
                  width={400}
                  height={0}
          ...
          <div className="bg-gradient-to-r from-[#1D3557] to-[#457B9D] p-1 rounded-xl shadow-lg">
            <div className="bg-white p-5 rounded-lg">
              <p className="text-center text-xl md:text-2xl font-bold text-[#1D3557]">
                Chegou a sua vez de ver seus alunos{' '}
                <span className="text-[#e63946] font-extrabold uppercase">pedindo para resolver mais continhas!</span>
              </p>
