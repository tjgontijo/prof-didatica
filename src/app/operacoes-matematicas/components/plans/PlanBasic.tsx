    ...
    <section id="plans" className="py-16 bg-gradient-to-b from-blue-50 to-white">
      <div className="container mx-auto px-4 max-w-3xl">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">Comece com o básico ou aproveite a oferta completa.</p>
        </div>
          ...
          <div className="p-8">
              ...
              <div className="mb-8">
                ...
                <ul className="space-y-3 max-w-md mx-auto text-left">
                  <li className="flex items-start p-2 hover:bg-blue-50 rounded-lg transition-colors">
                    ...
                    <span className="text-gray-600"><strong>Indicado para Fundamental I</strong></span>
                  </li>
                  <li className="flex items-start p-2 hover:bg-blue-50 rounded-lg transition-colors">
                    <Check className="text-[#457B9D] mt-1 mr-3 flex-shrink-0" />
                    <span className="text-gray-600"><strong>18 folhinhas em Pixel Art</strong> do Divertidamente II</span>
                  </li>
                  <li className="flex items-start p-2 hover:bg-blue-50 rounded-lg transition-colors">
                    <Check className="text-[#457B9D] mt-1 mr-3 flex-shrink-0" />
                    <span className="text-gray-600"><strong>4 operações matemáticas</strong> (adição, subtração, mult. e div.)</span>
                  </li>
                  <li className="flex items-start p-2 hover:bg-blue-50 rounded-lg transition-colors">
                    <Check className="text-[#457B9D] mt-1 mr-3 flex-shrink-0" />
                    <span className="text-gray-600"><strong>Gabarito completo</strong> em PDF</span>
                  </li>
                  <li className="flex items-start p-2 hover:bg-blue-50 rounded-lg transition-colors">
                    <Check className="text-[#457B9D] mt-1 mr-3 flex-shrink-0" />
                    <span className="text-gray-600"><strong>Acesso por 60 dias</strong> ao material</span>
                  </li>
                </ul>
              </div>
            ...
            <div className="text-center bg-gradient-to-r from-blue-50 to-emerald-50 p-6 rounded-lg">
              ...
              <p className="text-xl text-zinc-600 mb-4">
                Você leva R$ {bonusValue} em bônus GRÁTIS. Veja abaixo a oferta completa!
              </p>
