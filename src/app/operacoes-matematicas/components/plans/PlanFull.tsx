...
function CountdownTimer() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      setEstoque((prev) => Math.max(2, prev - 1));
    }, delay);
                ...
                <div className="mb-8">
                  ...
                  <ul className="space-y-3 max-w-md mx-auto text-left">
                    <li className="flex items-start p-2 hover:bg-emerald-50 rounded-lg transition-colors">
                      ...
                      <span className="text-gray-600"><strong>Indicado para Fundamental I e II</strong></span>
                    </li>
                    <li className="flex items-start p-2 hover:bg-emerald-50 rounded-lg transition-colors">
                      <Check className="text-emerald-600 mt-1 mr-3 flex-shrink-0" />
                    ...
                    <li className="flex items-start p-2 hover:bg-emerald-50 rounded-lg transition-colors">
                      <Check className="text-emerald-600 mt-1 mr-3 flex-shrink-0" />
                      <span className="text-gray-600"><strong>4 operações matemáticas</strong> completa em cada folha</span>
                    </li>
                    <li className="flex items-start p-2 hover:bg-emerald-50 rounded-lg transition-colors">
                      <Check className="text-emerald-600 mt-1 mr-3 flex-shrink-0" />
                      <span className="text-gray-600"><strong>Gabarito completo</strong> para consulta do professor</span>
                    </li>
                    <li className="flex items-start p-2 hover:bg-emerald-50 rounded-lg transition-colors">
                      <Check className="text-emerald-600 mt-1 mr-3 flex-shrink-0" />
                    ...
                    <li className="mt-2 border-t border-emerald-100 pt-4">
                      <p className="font-bold text-emerald-800 mb-2 flex items-center">
                        <Gem className="text-yellow-500 mr-2" /> Bônus Exclusivos (GRÁTIS):
                      </p>
                ...
                <div className="mb-8 relative">
                  ...
                  <div className="bg-white p-6 rounded-lg border border-emerald-200 shadow-sm">
                    <div className="flex flex-col items-center">
                      ...
                      <p className="text-emerald-700 font-bold text-sm mt-2 uppercase tracking-wide">Você economiza R$ 51,00</p>
