  ...
  const steps = [
    {
      ...
      description:
        'O material é 100% digital. Logo após a compra, você recebe tudo no seu E-mail, pronto para baixar e imprimir.',
      icon: Mail,
    },
    {
      title: 'Você imprime',
      description:
        'Imprima quantas cópias quiser. Você pode aplicar com a turma inteira e reutilizar o material o ano todo.',
      icon: Printer,
    },
    {
      title: 'A magia acontece',
      description:
        'A criança resolve a continha, pinta o pixel e revela o personagem. Ela nem percebe que está praticando matemática.',
      icon: Sparkles,
    },
  ];
