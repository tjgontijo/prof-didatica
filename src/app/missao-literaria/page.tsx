          ...
          <section className="text-center mb-20">
            <h1 className="text-2xl md:text-3xl font-black mb-6 md:leading-relaxed leading-normal tracking-tight relative text-[#1D3557]">
              <span className="relative z-10">
                CONHEÇA O MÉTODO DE LEITURA QUE FEZ ALUNOS DO <span className="text-[#457B9D] font-extrabold">FUNDAMENTAL 1</span> LEREM <span className="bg-yellow-100 px-1 py-0.5 rounded text-[#1D3557] font-extrabold">3X MAIS</span> EM APENAS <span className="underline decoration-[#a8dadc] decoration-4">21 DIAS</span> <span className="block">E DEVOLVEU AOS PROFESSORES O <span className="text-[#457B9D] animate-pulse font-extrabold">PRAZER EM ENSINAR</span></span>
              </span>
            </h1>
