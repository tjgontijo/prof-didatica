        ...
        <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section className="text-center mb-20">
            <h1 className="text-4xl md:text-5xl font-black mb-6 leading-tight tracking-tight relative text-[#1D3557] uppercase">
              <span className="relative z-10">
                Transforme seus alunos em{' '}
                <span className="text-[#457B9D] animate-pulse">leitores entusiasmados</span>{' '}
                <span className="underline">com missões prontas</span>
                <span className="text-[#1D3557]"> para aplicar</span>
              </span>
            </h1>
            <h2 className="text-lg md:text-xl text-[#1D3557] mb-6 max-w-3xl mx-auto font-normal leading-relaxed text-center">
              Aplique missões literárias prontas para engajar até os alunos que mais reclamam de
              ler. Economize tempo, traga leveza para a sua rotina e veja sua turma lendo mais e com
              entusiasmo.
            </h2>
            ...
            <div className="grid grid-cols-1 gap-4 max-w-xl mx-auto text-left mb-8">
              {[
                ...
                <div
                  key={index}
                  className="bg-[#f8f9fa] rounded-lg p-4 flex items-center gap-4 shadow-sm hover:shadow-md transition-all duration-300"
                >
            ...
            <div className="bg-white rounded-lg shadow-lg py-16 px-8 mb-20 mt-8">
              ...
              <div className="text-center mb-6">
                <p className="text-md text-gray-600 mt-2 italic mb-8">
                  ...
                  agora disponível por menos do que um lanche na cantina.
                </p>
          ...
          <section className="bg-white rounded-lg shadow-lg p-8 mb-20">
            ...
            <div className="max-w-2xl mx-auto text-left space-y-6">
              ...
              <p className="text-gray-800 text-xl leading-relaxed">
                A verdade é que o problema <span className="font-bold">não está em você</span>. E a
                solução não está em tentar mais uma atividade aleatória, sozinha.
              </p>

              <p className="text-xl text-[#457B9D] font-bold bg-[#f8f9fa] p-4 rounded-lg text-center">
                ✨ O que faltava era um sistema leve, pronto e motivador, que torne a leitura parte
                da rotina com significado. Um caminho onde o aluno se sente envolvido e o professor…
                realizado.
              </p>
            </div>
          </section>
                ...
                <div className="flex flex-col items-center space-y-4">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-white font-medium text-xl text-center">
                      Esse sistema já mudou a minha realidade e a de centenas de colegas que hoje
                      veem seus alunos lendo com vontade.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 gap-6 mb-8">
              ...
              <div className="bg-gradient-to-r from-[#f8f9fa] to-[#e9ecef] p-5 rounded-lg border-l-4 border-[#6bbbed] shadow-md">
                <div className="flex flex-col items-center space-y-3">
                  ...
                  <p className="text-gray-700 text-center">
                    Ao explorar histórias diversas, os alunos enriquecem a linguagem e aprendem a
                    interpretar melhor.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-[#f8f9fa] to-[#e9ecef] p-5 rounded-lg border-l-4 border-[#6bbbed] shadow-md">
                <div className="flex flex-col items-center space-y-3">
                  ...
                  <p className="text-gray-700 text-center">
                    As histórias lidas e as atividades propostas abrem espaço para invenção,
              ...
              <div className="bg-gradient-to-r from-[#f8f9fa] to-[#e9ecef] p-5 rounded-lg border-l-4 border-[#6bbbed] shadow-md">
                <div className="flex flex-col items-center space-y-3">
                  ...
                  <p className="text-gray-700 text-center">
                    As propostas de escrita ajudam os alunos a se expressarem melhor e organizarem
                    ideias com clareza.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-[#f8f9fa] to-[#e9ecef] p-5 rounded-lg border-l-4 border-[#6bbbed] shadow-md">
                <div className="flex flex-col items-center space-y-3">
                  ...
                  <p className="text-gray-700 text-center">
                    A estante interativa cria um clima de desafio entre os alunos, incentivando a
                    leitura contínua.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-[#f8f9fa] to-[#e9ecef] p-5 rounded-lg border-l-4 border-[#6bbbed] shadow-md">
                <div className="flex flex-col items-center space-y-3">
                  ...
                  <p className="text-gray-700 text-center">
                    A leitura vira um momento esperado da semana — os alunos se envolvem mais,
                    participam mais e se tornam protagonistas.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 gap-8 mb-8">
              <div className="bg-[#f8f9fa] p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                <div className="flex flex-col items-center">
                  ...
                  <p className="font-bold text-[#1D3557] text-xl mb-3 text-center">
                    20 fichas literárias envolventes
                  </p>
                  <p className="text-gray-800 text-left w-full">
                    Cada ficha é um roteiro completo para guiar a leitura, ajudando os alunos a
                    interpretar e se conectar com a história de forma significativa.
                  </p>
                </div>
              </div>
              <div className="bg-[#f8f9fa] p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-gray-800 text-left w-full">
                    Serão abordads questões e reflexões que incentivam os alunos a pensar
                    criticamente sobre o livro, desenvolvendo habilidades essenciais de
                    interpretação.
                  </p>
                </div>
              </div>
              <div className="bg-[#f8f9fa] p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                <div className="flex flex-col items-center">
                  <div className="text-4xl mb-3">🎨</div>
                  <p className="font-bold text-[#1D3557] text-xl mb-3 text-center">
                    Estante interativa para acompanhar o progresso
                  </p>
                  <p className="text-gray-800 text-left w-full">
                    Dois modelos de leitômetro onde cada aluno registra suas leituras, criando uma
                    competição saudável e motivação extra para ler cada vez mais.
                  </p>
                </div>
              </div>
              <div className="bg-[#f8f9fa] p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-gray-800 text-left w-full">
                    Exercícios práticos que estimulam a escrita criativa e ajudam os alunos a
                    expressar suas ideias sobre as histórias lidas em nosso bônus.
                  </p>
                </div>
              </div>
              <div className="bg-[#f8f9fa] p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                <div className="flex flex-col items-center">
                  <div className="text-4xl mb-3">📊</div>
                  <p className="font-bold text-[#1D3557] text-xl mb-3 text-center">
                    Tabela de acompanhamento personalizada
                  </p>
                  <p className="text-gray-800 text-left w-full">
                    Dois modelos, um em PDF e outro em Google Planilhas, para que você possa
                    registrar quais alunos já leram, o progresso de cada um e identificar quem
              ...
              <div className="bg-[#f8f9fa] p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-gray-800 text-left w-full">
                    Um guia claro e prático para você implementar o método com facilidade e garantir
                    que seus alunos aproveitem ao máximo o projeto.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-5">
                <div className="flex gap-3 items-center">
                  ...
                  <p className="text-xl text-gray-800 mb-4">
                    <strong>93%</strong> das professoras que aplicaram o Projeto Literário relatam
                    que seus alunos passaram a ler mais — inclusive aqueles que diziam não gostar de
                    ler.
                  </p>
                </div>
                <div className="flex gap-3 items-center">
                  <div className="text-xl min-w-[30px]">📈</div>
                  <p className="text-xl text-gray-800 mb-4">
                    O número médio de livros lidos por turma <strong>mais do que dobrou</strong> em
                    apenas um semestre após a aplicação do projeto.
                  </p>
                </div>
                <div className="flex gap-3 items-center">
                  <div className="text-xl min-w-[30px]">🏆</div>
                  <p className="text-xl text-gray-800 mb-4">
                    ...
                    <strong>8 mil alunos</strong> em salas de aula reais.
                  </p>
                </div>
              </div>
            </div>
            <div className="bg-[#457B9D] text-white p-6 rounded-lg mb-8">
              ...
              <div className="bg-white text-gray-800 p-5 rounded-lg shadow-md mb-4">
                <p className="italic mb-3">
                  &ldquo;Sinceramente? Eu já estava cansada. Sentia que tudo que eu fazia era
                  ignorado. Quando comecei o projeto, achei que ia ser só mais uma tentativa. Mas
                  não. Pela primeira vez, vi meus alunos empolgados com leitura. Eu chorei em casa
                  depois da aula. Foi a primeira vez em muito tempo que me senti fazendo diferença
                  de novo.&rdquo;
                </p>
              ...
              <div className="bg-white text-gray-800 p-5 rounded-lg shadow-md mb-4">
                <p className="italic mb-3">
                  ...
                  semanas usando o projeto, eles começaram a pedir mais. Um deles até me perguntou
                  quando seria a próxima leitura. Eu fiquei em choque, de verdade. É simples, mas
                  funciona.&rdquo;
                </p>
              ...
              <div className="bg-white text-gray-800 p-5 rounded-lg shadow-md">
                <p className="italic mb-3">
                  ...
                  Hoje em dia, com tanto estímulo rápido, competir com um livro virou quase
                  impossível. Mas com o projeto, algo virou. Os alunos começaram a participar,
                  comentar os livros, até competir entre si. Eu voltei a sentir vontade de planejar.
                  Foi como tirar um peso das costas.&rdquo;
                </p>
          ...
          <section className="bg-white rounded-lg shadow-lg p-8 mb-20">
            ...
            <p className="text-xl text-[#1D3557] mb-8 text-left leading-relaxed">
              O segredo está no equilíbrio entre emoção, estrutura e incentivo. O aluno é guiado com
              leveza e motivado a continuar porque se sente parte de um desafio real e estimulante.
            </p>
            ...
            <div className="grid grid-cols-1 gap-8 mb-8">
              ...
              <div className="bg-[#f8f9fa] p-6 rounded-lg border-l-4 border-[#e63946]">
                ...
                <ul className="space-y-2 text-gray-800">
                  ...
                  <li>
                    • Falta de acompanhamento claro: o professor tenta de tudo, mas não consegue
                    medir o progresso
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-[#f8f9fa] p-6 rounded-lg border-l-4 border-[#6bbbed]">
                ...
                <ul className="space-y-2 text-gray-800">
                  <li>
                    • Cada ficha guia a leitura de forma estruturada, despertando o lado emocional e
                    imaginativo da criança
                  </li>
                  <li>
                    • A estante interativa cria uma competição saudável e visível, os alunos querem
                    avançar por vontade própria
                  </li>
                  <li>
                    • O professor aplica com facilidade e consegue acompanhar o progresso de forma
                    clara e prática
                  </li>
                </ul>
              </div>
          ...
          <section className="bg-white rounded-lg shadow-lg p-8 mb-20">
            ...
            <p className="text-xl text-gray-800 mb-4 leading-relaxed">
              Você pode continuar tentando sozinha, montando tudo do zero, insistindo com
              estratégias que cansam você mais do que engajam os alunos...
            </p>
            <p className="text-xl text-gray-800 mb-4 leading-relaxed">
              Ou pode aplicar um recurso leve, pronto e já validado por milhares de professores que
              transforma a leitura em algo que seus alunos realmente querem viver.
            </p>
            <p className="fontext-md italic text-[#1D3557] mb-8 leading-relaxed">
              📌 O acesso com desconto e bônus está liberado só por tempo limitado. Se sentir que é
              pra você, essa é a hora de fazer diferente.
            </p>
            <a
              href={offerData.paymentLink}
              rel="noopener noreferrer"
            ...
            <div className="space-y-4 max-w-3xl mx-auto">
                ...
                <details className="group">
                  ...
                  <div className="p-4 bg-white">
                    <p className="text-gray-800">
                      ...
                      Fundamental I. Já foi aplicado com sucesso do 2º ao 5º ano, com excelente
                      adaptação em diferentes realidades.
                    </p>
                  </div>
                </details>
              </div>
              ...
              <div className="border border-[#a8dadc] rounded-lg overflow-hidden">
                <details className="group">
                  ...
                  <div className="p-4 bg-white">
                    <p className="text-gray-800">
                      O material é 100% digital, em PDF. Assim que a compra é confirmada, você
                      recebe tudo por Whatsapp, pronto para baixar e imprimir quantas vezes quiser.
                    </p>
                  </div>
                </details>
              </div>
              ...
              <div className="border border-[#a8dadc] rounded-lg overflow-hidden">
                <details className="group">
                  ...
                  <div className="p-4 bg-white">
                    <p className="text-gray-800">
                      Depois do pagamento, você vai receber uma mensagem no seu Whatsapp com o link
                      do Google Drive para baixar seus materiais. É tudo simples, direto e com
                      acesso imediato.
                    </p>
                  </div>
                </details>
