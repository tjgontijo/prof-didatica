...
export default function ThanksClientComponent({ pixData, transactionId }: ThanksClientComponentProps) {
    ...
    <div className="min-h-screen bg-white font-sans text-[#333]">
      ...
      <main className="container mx-auto py-6 px-4 max-w-[600px]">
        <div className="bg-white rounded-[12px] p-6 shadow-sm border border-gray-200">
          ...
          <div className={`flex items-center gap-3 mb-4 p-4 rounded-lg ${status === 'approved' ? 'bg-green-50' : 'bg-blue-50'}`}>
            <div className="flex-shrink-0">
              {status === 'approved' ? (
                ...
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M12 6C8.68629 6 6 8.68629 6 12C6 15.3137 8.68629 18 12 18C15.3137 18 18 15.3137 18 12C18 8.68629 15.3137 6 12 6Z" stroke="#2563EB" strokeWidth="2"/>
                  <path d="M12 8.5V12L14.5 14.5" stroke="#2563EB" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              )}
            </div>
            <h2 className={`text-lg font-medium ${status === 'approved' ? 'text-green-700' : 'text-blue-700'}`}>
          ...
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-600">
              Quando o pagamento for aprovado, você receberá no WhatsApp <span className="font-medium">{pixData.order?.customer?.phone || ''}</span> as informações sobre seu(s) produto(s). Fique atento às mensagens recebidas.
            </p>
          </div>
          ...
          <div className="mb-4">
            ...
            {pixData.qr_code_base64 && (
              <div className="flex justify-center mb-3">
                <Image
                  src={pixData.qr_code_base64 ? `data:image/png;base64,${pixData.qr_code_base64}` : '/images/system/logo_transparent.webp'}
                  alt="QR Code PIX"
                  width={180}
                  height={180}
              ...
              <div className="bg-gray-50 p-4 rounded-lg mt-2">
                <ol className="space-y-4">
                  <li className="flex gap-3">
                    ...
                    <div className="text-sm">Abra o aplicativo do seu banco e acesse a área Pix</div>
                  </li>
                  <li className="flex gap-3">
                    ...
                    <div className="text-sm">Selecione a opção "pagar com código Pix Copia e Cola" e cole o código no espaço indicado no aplicativo</div>
                  </li>
                  <li className="flex gap-3">
                    ...
                    <div className="text-sm">Após o pagamento, você receberá por email as informações de acesso à sua compra</div>
                  </li>
                </ol>
              </div>
            )}
            ...
            <div className="space-y-3">
              ...
              {orderItems.length > 0 ? (
                <div className="space-y-3">
                  ...
                  {orderItems.filter(item => !item.isOrderBump).map((item) => (
                      ...
                      <div className="flex gap-3 items-center">
                        ...
                        <div className="flex-1">
                          <p className="text-[14px] text-[#333]">
                            {item.title.length > 35 ? `${item.title.substring(0, 35).trim()}...` : item.title}
                          </p>
                        </div>
                      </div>
              ...
              <div className="text-xs text-gray-500 mt-2">
                Código da transação: {transactionId}
              </div>
            </div>
          </div>
        </div>
