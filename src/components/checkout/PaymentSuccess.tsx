  ...
  return (
    <div className="bg-white rounded-[8px] p-5 mb-6 text-center">
      <div className="flex flex-col items-center space-y-4">
        ...
        <h2 className="text-[18px] font-bold text-[#333]">Pagamento confirmado!</h2>

        <p className="text-[14px] text-[#666]">
          Olá, <span className="font-bold">{firstName}</span>! Seu pagamento para{' '}
          <span className="font-bold">{productName}</span> foi confirmado com sucesso.
        </p>
        ...
        <div className="border-t border-[#EEE] pt-4 mt-4 w-full">
          <p className="text-[12px] text-[#999]">
            Um e-mail com os detalhes da sua compra foi enviado para o seu endereço de e-mail
            cadastrado.
          </p>
        </div>
      </div>
