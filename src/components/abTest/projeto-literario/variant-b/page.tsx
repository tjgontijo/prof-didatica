...
export default function VariantB({ testId }: VariantBProps) {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#f8f9fa]">
      ...
      {process.env.NODE_ENV === 'development' && (
        <div className="fixed top-2 right-2 bg-blue-600 text-white px-3 py-1 rounded-full text-xs font-bold shadow-lg z-50">
          Variante B
        </div>
      )}
